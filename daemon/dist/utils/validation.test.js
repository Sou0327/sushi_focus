...
import { validateString, validateOptionalString, validateNumber, } from './validation.js';
describe('validateString', () => {
    ...
    it('最大長超過を拒否する', () => {
        expect(validateString('hello world', 'name', 5)).toBe('name exceeds maximum length of 5 characters');
    });
    it('非文字列を拒否する', () => {
...
describe('validateOptionalString', () => {
    ...
    it('最大長超過を拒否する', () => {
        expect(validateOptionalString('hello world', 'name', 5)).toBe('name exceeds maximum length of 5 characters');
    });
    it('非文字列を拒否する', () => {
